...
select eno, ename, salary, job, dno, commission, salary*12, salary*12+commission 
from employee;

select eno, ename, salary 월급, job 직무, dno 부서번호, nvl(commission, 0) 보너스, salary*12, salary*12+nvl(commission, 0) 연봉
from employee;

select eno, ename, salary, job, dno, nvl(commission, 0), salary*12, salary*12+nvl(commission, 0) as 연봉
from employee;

select eno, ename, salary, job, dno, nvl(commission, 0), salary*12, salary*12+nvl(commission, 0) "연 봉"
from employee;
...
from employee; /*같이보게되면 중복이 안되는것들만 출력*/
